  ...
  return (
    ...
    >
      <div className="mx-auto max-w-375 px-4 md:px-8 py-4">
        <div
          className={`h-20 md:h-22 px-4 md:px-6 rounded-full border flex items-center justify-between gap-4 ${scrolled ? "border-border/70 bg-stone/72" : "border-stone/15 bg-stone/8 backdrop-blur-2xl"}`}
        >
          ...
          <nav className="px-6 py-6 flex flex-col gap-3">
            {NAV.map((n) => (
              <Link
                key={n.to}
                to={n.to}
                className="flex items-baseline gap-3 rounded-2xl px-4 py-3 text-foreground hover:bg-secondary/60"
              >
            ...
            <Link
              to="/contact"
              className="mt-2 inline-flex w-fit rounded-full bg-ink px-5 py-3 text-xs uppercase tracking-widest text-stone"
            >
              旅の相談 →
            </Link>
          </nav>
      ...
      <div className="mx-auto max-w-350 px-6 md:px-10 py-20 grid gap-12 md:grid-cols-12">
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-2.5 text-sm font-jp">
            <li>
              <Link to="/destinations" className="hover:text-stone">
                隠れた地
              </Link>
            </li>
            <li>
              <Link to="/seasonal" className="hover:text-stone">
                四季の旅
              </Link>
            </li>
            <li>
              <Link to="/temples" className="hover:text-stone">
                古寺巡礼
              </Link>
            </li>
            <li>
              <Link to="/cafes" className="hover:text-stone">
                里の喫茶
              </Link>
            </li>
            <li>
              <Link to="/guides" className="hover:text-stone">
                旅の手引き
              </Link>
            </li>
          </ul>
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-2.5 text-sm font-jp">
            <li>
              <Link to="/journal" className="hover:text-stone">
                紀行
              </Link>
            </li>
            <li>
              <Link to="/about" className="hover:text-stone">
                私たちについて
              </Link>
            </li>
            <li>
              <Link to="/faq" className="hover:text-stone">
                よくある質問
              </Link>
            </li>
            <li>
              <Link to="/contact" className="hover:text-stone">
                お問い合わせ
              </Link>
            </li>
          </ul>
        ...
        <div className="md:col-span-4">
          ...
          <form
            className="flex border border-stone/30 bg-stone/5"
      ...
      <div className="border-t border-stone/15">
        <div className="mx-auto max-w-350 px-6 md:px-10 py-6 flex flex-col md:flex-row items-center justify-between gap-4 text-[11px] opacity-60">
          ...
          <div className="flex gap-6">
            <Link to="/privacy" className="hover:text-stone">
              Privacy
            </Link>
    ...
    <section className="relative h-[68vh] min-h-120 w-full overflow-hidden">
      ...
      <div className="relative h-full mx-auto max-w-350 px-6 md:px-10 flex flex-col justify-end pb-16">
        <div className="mb-6 inline-flex items-center gap-3">
          ...
          <div className={`text-[10px] tracking-[0.4em] uppercase ${toneStyles.label}`}>
            {eyebrow}
          </div>
        </div>
        ...
        <div
          className={`mt-8 inline-flex self-start rounded-full border px-4 py-2 text-[10px] tracking-[0.35em] uppercase ${toneStyles.chip}`}
        >
          Edited in Kyoto
        </div>
      </div>
