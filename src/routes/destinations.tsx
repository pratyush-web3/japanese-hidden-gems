  ...
  head: () => ({
    meta: [
      { title: "隠れた地 · Hidden Destinations — Kakushi" },
      {
        name: "description",
        content:
          "An editorial index of Japan's hidden villages, mountain towns, coastal hamlets and rural retreats.",
      },
            ...
            return (
              <article key={d.slug} className="grid md:grid-cols-12 gap-10 md:gap-16 items-center">
                ...
                <div className="md:col-span-5">
                  ...
                  <p className="font-jp text-base leading-loose text-foreground/80 mb-8">
                    {d.excerpt}
                  </p>
                  ...
                  <Link
                    to="/destinations/$slug"
                    params={{ slug: d.slug }}
                    className="inline-flex items-center text-sm tracking-[0.25em] uppercase text-forest border-b border-forest/40 pb-1 hover:border-forest"
                  >
                    詳しく読む →
                  </Link>
                </div>
