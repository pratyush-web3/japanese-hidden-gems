  ...
  head: () => ({
    meta: [
      { title: "Kakushi · 隠し — A Journal of Hidden Japan" },
      {
        name: "description",
        content:
          "An editorial guide to Japan's hidden villages, rural cafés, forgotten temples and quiet seasonal journeys.",
      },
    ...
    <SiteLayout>
        ...
        <div className="relative h-full mx-auto max-w-375 px-6 md:px-10 flex flex-col justify-between pt-32 pb-16">
          ...
          >
            <div className="inline-flex items-center gap-3 mb-8 rounded-full border border-stone/20 bg-stone/12 px-4 py-2 backdrop-blur-md">
              ...
              <div className="text-[10px] tracking-[0.5em] uppercase opacity-90">
                No. 014 — Winter Issue
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <Link
                to="/journal"
                className="rounded-full border border-stone/15 bg-white/5 px-5 py-3 text-sm tracking-[0.25em] uppercase text-stone/85 backdrop-blur-md hover:text-stone"
              >
                Read the journal
              </Link>
            </div>
        ...
        <div className="mx-auto max-w-350 px-6 md:px-10">
          <div className="flex items-end justify-between mb-16 flex-wrap gap-6">
            <div>
              ...
              <h2 className="font-jp text-4xl md:text-5xl text-forest-deep">
                この冬、訪ねたい三つの里
              </h2>
            </div>
            <Link
              to="/destinations"
              className="text-sm tracking-[0.25em] uppercase text-forest hover:text-forest-deep border-b border-forest/40 pb-1"
            >
              すべて見る →
            </Link>
          </div>
      ...
      <section className="py-32 mx-auto max-w-350 px-6 md:px-10">
        <div className="grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-5">
            ...
            <Link
              to="/destinations"
              className="inline-flex items-center text-sm tracking-[0.25em] uppercase border-b border-forest pb-2 text-forest hover:text-forest-deep"
            >
              地図で探す →
            </Link>
          </div>
          ...
          <div className="md:col-span-7 grid grid-cols-2 gap-px bg-border">
            {[
              ...
              <div
                key={r.en}
                className={`bg-background p-8 hover:bg-secondary/50 transition-colors cursor-pointer group ${index % 2 === 0 ? "panel-frame" : ""} ${r.accent}`}
              >
      ...
      <section className="relative">
        <div className="grid md:grid-cols-2 min-h-150">
          <div className="relative overflow-hidden">
            <img
              src={images.ruralCafe}
              alt="rural cafe interior"
              loading="lazy"
          ...
          <div className="bg-forest-deep text-stone p-12 md:p-20 flex flex-col justify-center">
            ...
            <div className="space-y-5 mb-10">
              {cafes.slice(0, 4).map((c) => (
                <div
                  key={c.name}
                  className="flex items-baseline gap-4 border-b border-stone/15 pb-4"
                >
            ...
            <Link
              to="/cafes"
              className="self-start text-sm tracking-[0.25em] uppercase border-b border-stone/60 pb-2 hover:border-stone"
            >
              喫茶の手帖を読む →
            </Link>
          </div>
      ...
      <section className="py-32 bg-forest-deep text-stone relative overflow-hidden">
        ...
        <div className="mx-auto max-w-275 px-6 md:px-10 text-center">
          <div className="text-stone/60 text-[10px] tracking-[0.4em] uppercase mb-8">
            — 旅人の声 · From Our Readers —
          </div>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-10 text-left">
            {[
              {
                quote:
                  "丁寧に選ばれた宿、丁寧に書かれた言葉。ページをめくるたびに、まだ見ぬ場所への憧れが静かに育つ。",
                who: "Marc D. / Paris",
              },
              {
                quote:
                  "妻籠の夜の提灯、忘れられない。Kakushiがなければ、私たちはここに来なかった。",
                who: "Sarah W. / Melbourne",
              },
              {
                quote: "美山の囲炉裏端で過ごした三日間は、人生で最も静かな時間だった。",
                who: "Hiroshi T. / Osaka",
              },
            ].map((t) => (
      ...
      <section className="py-32 mx-auto max-w-375 px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <div
              key={i}
              className={`relative overflow-hidden panel-frame ${i % 5 === 0 ? "row-span-2 aspect-3/4" : "aspect-square"}`}
            >
              <img
                src={img}
                alt=""
      ...
      <section className="py-32 mx-auto max-w-225 px-6 text-center">
        ...
        <form
          className="flex max-w-md mx-auto border border-forest/40"
