  ...
  return (
    <SiteLayout>
      ...
      <section className="relative h-screen min-h-[680px] w-full overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-forest-deep/30 via-transparent to-forest-deep/80" />
        <div className="absolute inset-0 grain" />

        <div className="relative h-full mx-auto max-w-[1400px] px-6 md:px-10 flex flex-col justify-end pb-24">
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.2, ease: "easeOut" }}
            className="text-stone/90"
          >
            <div className="text-[10px] tracking-[0.5em] uppercase mb-8 opacity-80">
              No. 014 — 冬の号 · Winter Issue
            </div>
            <h1 className="font-jp text-stone text-[10vw] md:text-[7vw] leading-[0.95] mb-6">
              知られざる<br />日本へ。
            </h1>
            <div className="font-display text-stone/85 text-2xl md:text-4xl italic max-w-2xl mb-10">
              A quiet journal of villages, temples, and the slow trains that carry you to them.
            </div>
            <div className="flex items-center gap-6">
              <Link
                to="/destinations"
                className="group inline-flex items-center gap-3 text-stone border-b border-stone/60 pb-2 text-sm tracking-[0.25em] uppercase hover:border-stone"
              >
                旅をはじめる <span className="group-hover:translate-x-1 transition-transform">→</span>
              </Link>
              <Link to="/journal" className="text-stone/70 text-sm tracking-[0.25em] uppercase hover:text-stone">
                Read the journal
              </Link>
            </div>
          </motion.div>
      ...
      {/* INTRODUCTION */}
      <section className="py-32 md:py-44 mx-auto max-w-[1100px] px-6 md:px-10 text-center">
      ...
      <section className="py-32 mx-auto max-w-[1400px] px-6 md:px-10">
        <div className="grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-7 grid grid-cols-2 gap-px bg-border">
            {[
              { jp: "東北", en: "Tohoku", count: "12" },
              { jp: "中部", en: "Chubu", count: "18" },
              { jp: "近畿", en: "Kinki", count: "21" },
              { jp: "中国", en: "Chugoku", count: "9" },
              { jp: "四国", en: "Shikoku", count: "11" },
              { jp: "九州", en: "Kyushu", count: "14" },
            ].map((r) => (
              <div key={r.en} className="bg-background p-8 hover:bg-secondary/50 transition-colors cursor-pointer group">
      ...
      <section className="relative">
        <div className="grid md:grid-cols-2 min-h-[600px]">
          <div className="relative">
            <img src={images.ruralCafe} alt="rural cafe interior" loading="lazy" className="absolute inset-0 w-full h-full object-cover" />
          </div>
      ...
      {/* GALLERY */}
      <section className="py-32 mx-auto max-w-[1500px] px-6">
