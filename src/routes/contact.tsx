  ...
  head: () => ({
    meta: [
      { title: "お問い合わせ · Contact — Kakushi" },
      {
        name: "description",
        content:
          "Get in touch with the Kakushi editorial team — for travel planning, story pitches, or quiet correspondence.",
      },
      ...
      <section className="py-24 mx-auto max-w-275 px-6 grid md:grid-cols-2 gap-16">
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div>
            ...
            <input
              type="email"
              className="w-full border-b border-border bg-transparent py-3 focus:outline-none focus:border-forest"
            />
          </div>
          <div>
            <label className="text-[10px] tracking-[0.3em] uppercase text-muted-foreground mb-2 block">
          ...
          <div>
            ...
            <textarea
              rows={6}
              className="w-full border-b border-border bg-transparent py-3 focus:outline-none focus:border-forest font-jp resize-none"
            />
          </div>
